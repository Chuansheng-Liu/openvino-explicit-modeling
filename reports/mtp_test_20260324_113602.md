# MTP Test Report 2026-03-24 11:36:02
...
TPOT: 50.64 ms/token
Throughput: 19.75 tokens/s
Based on the text you provided, here is a summary of the key features and specifications of the newly unveiled **MacBook Neo**:

### **Core Specifications**
*   **Chassis:** Durable aluminum enclosure with soft, rounded corners.
*   **Weight:** Just 2.7 pounds (lightweight for portability).
*   **Display:** 13-inch Liquid Retina display with:
    *   Resolution: 2408-by-1506.
    *   Brightness: 500 nits.
    *   Color: Support for 1 billion colors.
    *   Features: Anti-reflective coating for comfortable viewing in various lighting.
*   **Performance Chip:** A18 Pro (Apple Silicon).
    *   CPU: Up to 50% faster for everyday tasks compared to the latest Intel Core Ultra 5 PCs.
    *   GPU: Integrated 5-core GPU for graphics and gaming.
    *   Neural Engine: 16-core, supporting fast on-device AI tasks (e.g., summarizing notes, cleaning up photos) while keeping data private.
*   **Battery:** Up to 16 hours of battery life.
*   **Audio/Video:**
    *   1080p FaceTime HD camera with dual mics.
